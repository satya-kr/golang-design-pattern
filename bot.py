...
import logging
import oci
availabilityDomains = ["NDWK:AP-MUMBAI-1-AD-1"]
displayName = 'ubuntu4x24'
compartmentId = 'ocid1.tenancy.oc1..aaaaaaaat7dhf4v6jtttgrrcrxvlc336x4souaanlw3qcx4aiyjh5pz3foma'
imageId = "ocid1.image.oc1.ap-mumbai-1.aaaaaaaaxwmwy3qwg4qm3nt6vkgxm6w64augvnxzgzd7vgvc6nxymvaipdma"
subnetId = 'ocid1.subnet.oc1.ap-mumbai-1.aaaaaaaaueniudkx542sfct4aa22vjzsdr5vesmzlpov6c33x34dzciau4dq'
ssh_authorized_keys = "ssh-rsa  ssh-key-2023-04-06"
    ...
    for availabilityDomain in availabilityDomains:
        instance_detail = oci.core.models.LaunchInstanceDetails(
            ...
            source_details=oci.core.models.InstanceSourceViaBootVolumeDetails(
                source_type="bootVolume", boot_volume_id=imageId, boot_volume_size_in_gbs=200),
